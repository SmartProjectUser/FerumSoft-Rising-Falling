...
namespace Rectum
{
  public static class BitmapDrawingExtensions
  {
    ...
    public static void DrawPixel(this Texture2D texture, int x, int y, Color color)
    {
      ...
      texture.SetPixel(x, TransformToLeftTopY(y, texture.height), color);
    }
    ...
    public static void DrawPixel(this Texture2D texture, int x, int y, int width, int height, Color color)
    {
      ...
      texture.SetPixel(x, TransformToLeftTopY(y, height), color);
    }
    ...
    {
      Point start = new Point(startX, TransformToLeftTopY(startY, texture.height));
    ...
    public static void DrawFilledRectangle(this Texture2D texture, Rect rectangle, Color color)
    {
      ...
      int transformedY = TransformToLeftTopY(rectangle.y, texture.height) - (int)rectangle.height;
    ...
    private static int TransformToLeftTopY(int y, int height)
    {
      return height - y;
    }
    ...
    /// <summary>
    /// Transforms a point in the texture plane so that 0,0 points at left-top corner.</summary>
    private static int TransformToLeftTopY(float y, int height)
    {
      return height - (int)y;
    }
  }
